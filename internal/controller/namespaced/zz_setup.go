...
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	for _, setup := range []func(ctrl.Manager) error{
		...
		updates.SetupWebhookWithManager,
		tokenag.SetupWebhookWithManager,
		extension.SetupWebhookWithManager,
		alerting.SetupWebhookWithManager,
		profile.SetupWebhookWithManager,
		towernotification.SetupWebhookWithManager,
		detection.SetupWebhookWithManager,
		tokenapi.SetupWebhookWithManager,
		monitoring.SetupWebhookWithManager,
		anomalies.SetupWebhookWithManager,
		dataprivacy.SetupWebhookWithManager,
		detectionrule.SetupWebhookWithManager,
		detectionrulev2.SetupWebhookWithManager,
		errorrules.SetupWebhookWithManager,
		notification.SetupWebhookWithManager,
		alertingattack.SetupWebhookWithManager,
		allowlist.SetupWebhookWithManager,
		rules.SetupWebhookWithManager,
		settings.SetupWebhookWithManager,
		allowlistattribute.SetupWebhookWithManager,
		blocklist.SetupWebhookWithManager,
		masking.SetupWebhookWithManager,
		preferences.SetupWebhookWithManager,
		log.SetupWebhookWithManager,
		approval.SetupWebhookWithManager,
		businesscalendar.SetupWebhookWithManager,
		controllerconnections.SetupWebhookWithManager,
		schedulingrule.SetupWebhookWithManager,
		workflow.SetupWebhookWithManager,
		workflowawsconnections.SetupWebhookWithManager,
		workflowjira.SetupWebhookWithManager,
		workflowk8sconnections.SetupWebhookWithManager,
		workflowslack.SetupWebhookWithManager,
		autotag.SetupWebhookWithManager,
		rulesautotag.SetupWebhookWithManager,
		v2.SetupWebhookWithManager,
		anomaliesaws.SetupWebhookWithManager,
		connection.SetupWebhookWithManager,
		connectionrolearn.SetupWebhookWithManager,
		credentials.SetupWebhookWithManager,
		service.SetupWebhookWithManager,
		connectionazure.SetupWebhookWithManager,
		connectionauthentication.SetupWebhookWithManager,
		credentialsazure.SetupWebhookWithManager,
		serviceazure.SetupWebhookWithManager,
		monitor.SetupWebhookWithManager,
		monitoroutage.SetupWebhookWithManager,
		monitorperformance.SetupWebhookWithManager,
		processmonitoring.SetupWebhookWithManager,
		eventsbuckets.SetupWebhookWithManager,
		eventscapturingvariants.SetupWebhookWithManager,
		eventsmetrics.SetupWebhookWithManager,
		eventsoneagent.SetupWebhookWithManager,
		eventsoneagentoutgoing.SetupWebhookWithManager,
		eventsprocessing.SetupWebhookWithManager,
		eventssecuritycontext.SetupWebhookWithManager,
		mobilemetric.SetupWebhookWithManager,
		servicemetric.SetupWebhookWithManager,
		syntheticmetric.SetupWebhookWithManager,
		webmetric.SetupWebhookWithManager,
		developmentenvironments.SetupWebhookWithManager,
		foundry.SetupWebhookWithManager,
		workloaddetection.SetupWebhookWithManager,
		credentialscloudfoundry.SetupWebhookWithManager,
		alerts.SetupWebhookWithManager,
		builtinrule.SetupWebhookWithManager,
		registry.SetupWebhookWithManager,
		rule.SetupWebhookWithManager,
		technology.SetupWebhookWithManager,
		analytics.SetupWebhookWithManager,
		credentialscredentials.SetupWebhookWithManager,
		anomaliescustom.SetupWebhookWithManager,
		appanomalies.SetupWebhookWithManager,
		appcrashrate.SetupWebhookWithManager,
		appenablement.SetupWebhookWithManager,
		device.SetupWebhookWithManager,
		servicecustom.SetupWebhookWithManager,
		serviceorder.SetupWebhookWithManager,
		tags.SetupWebhookWithManager,
		units.SetupWebhookWithManager,
		dashboard.SetupWebhookWithManager,
		sharing.SetupWebhookWithManager,
		allowlistdashboards.SetupWebhookWithManager,
		general.SetupWebhookWithManager,
		presets.SetupWebhookWithManager,
		privacy.SetupWebhookWithManager,
		anomaliesdatabase.SetupWebhookWithManager,
		anomaliesv2.SetupWebhookWithManager,
		anomalydetectors.SetupWebhookWithManager,
		copilot.SetupWebhookWithManager,
		appfeatureflags.SetupWebhookWithManager,
		pool.SetupWebhookWithManager,
		grouping.SetupWebhookWithManager,
		launchpad.SetupWebhookWithManager,
		agentoptin.SetupWebhookWithManager,
		datamasking.SetupWebhookWithManager,
		gitonprem.SetupWebhookWithManager,
		shares.SetupWebhookWithManager,
		defaultrules.SetupWebhookWithManager,
		featureflags.SetupWebhookWithManager,
		analyticsdisk.SetupWebhookWithManager,
		anomaliesdisk.SetupWebhookWithManager,
		anomaliesv2disk.SetupWebhookWithManager,
		anomalyrules.SetupWebhookWithManager,
		edgeanomalydetectors.SetupWebhookWithManager,
		options.SetupWebhookWithManager,
		specificanomaliesv2.SetupWebhookWithManager,
		document.SetupWebhookWithManager,
		servicediscovery.SetupWebhookWithManager,
		notificationemail.SetupWebhookWithManager,
		detectionrules.SetupWebhookWithManager,
		detectionrulesoptin.SetupWebhookWithManager,
		environment.SetupWebhookWithManager,
		settingseula.SetupWebhookWithManager,
		drivenansibleconnections.SetupWebhookWithManager,
		executioncontroller.SetupWebhookWithManager,
		executionremote.SetupWebhookWithManager,
		detectionparameters.SetupWebhookWithManager,
		detectionrulesfailure.SetupWebhookWithManager,
		detectionrulesets.SetupWebhookWithManager,
		issues.SetupWebhookWithManager,
		relationships.SetupWebhookWithManager,
		setting.SetupWebhookWithManager,
		types.SetupWebhookWithManager,
		geolocation.SetupWebhookWithManager,
		connectiongithub.SetupWebhookWithManager,
		connectiongitlab.SetupWebhookWithManager,
		state.SetupWebhookWithManager,
		metricsallowall.SetupWebhookWithManager,
		metricsallowlist.SetupWebhookWithManager,
		securitycontext.SetupWebhookWithManager,
		metrics.SetupWebhookWithManager,
		anomalieshost.SetupWebhookWithManager,
		anomaliesv2host.SetupWebhookWithManager,
		monitoringhost.SetupWebhookWithManager,
		monitoringadvanced.SetupWebhookWithManager,
		monitoringmode.SetupWebhookWithManager,
		naming.SetupWebhookWithManager,
		namingorder.SetupWebhookWithManager,
		processgroupmonitoring.SetupWebhookWithManager,
		monitorhttp.SetupWebhookWithManager,
		monitorcookies.SetupWebhookWithManager,
		monitoroutagehttp.SetupWebhookWithManager,
		monitorperformancehttp.SetupWebhookWithManager,
		monitorscript.SetupWebhookWithManager,
		extensionactiveversion.SetupWebhookWithManager,
		extensionconfig.SetupWebhookWithManager,
		permissions.SetupWebhookWithManager,
		subscriptions.SetupWebhookWithManager,
		...
		mqfilters.SetupWebhookWithManager,
		bridges.SetupWebhookWithManager,
		appfeatureflagsinfraops.SetupWebhookWithManager,
		appsettings.SetupWebhookWithManager,
		addressmasking.SetupWebhookWithManager,
		tracking.SetupWebhookWithManager,
		connectionjenkins.SetupWebhookWithManager,
		notificationjira.SetupWebhookWithManager,
		dashboardjson.SetupWebhookWithManager,
		dashboardbase.SetupWebhookWithManager,
		clusteranomalies.SetupWebhookWithManager,
		credentialsk8s.SetupWebhookWithManager,
		monitoringk8s.SetupWebhookWithManager,
		namespaceanomalies.SetupWebhookWithManager,
		nodeanomalies.SetupWebhookWithManager,
		pvcanomalies.SetupWebhookWithManager,
		workloadanomalies.SetupWebhookWithManager,
		requests.SetupWebhookWithManager,
		useraction.SetupWebhookWithManager,
		app.SetupWebhookWithManager,
		enrichment.SetupWebhookWithManager,
		kubernetes.SetupWebhookWithManager,
		spm.SetupWebhookWithManager,
		outboundconnections.SetupWebhookWithManager,
		agentfeatureflags.SetupWebhookWithManager,
		buckets.SetupWebhookWithManager,
		customattribute.SetupWebhookWithManager,
		customsource.SetupWebhookWithManager,
		debugsettings.SetupWebhookWithManager,
		events.SetupWebhookWithManager,
		grail.SetupWebhookWithManager,
		metricslog.SetupWebhookWithManager,
		oneagent.SetupWebhookWithManager,
		processing.SetupWebhookWithManager,
		securitycontextlog.SetupWebhookWithManager,
		sensitivedatamasking.SetupWebhookWithManager,
		storage.SetupWebhookWithManager,
		timestamp.SetupWebhookWithManager,
		transactionmonitoring.SetupWebhookWithManager,
		maintenance.SetupWebhookWithManager,
		window.SetupWebhookWithManager,
		backup.SetupWebhookWithManager,
		internetproxy.SetupWebhookWithManager,
		networkzones.SetupWebhookWithManager,
		preferencesmanaged.SetupWebhookWithManager,
		publicendpoints.SetupWebhookWithManager,
		remoteaccess.SetupWebhookWithManager,
		smtp.SetupWebhookWithManager,
		zone.SetupWebhookWithManager,
		zonev2.SetupWebhookWithManager,
		eventsmetric.SetupWebhookWithManager,
		metadata.SetupWebhookWithManager,
		query.SetupWebhookWithManager,
		permissionmgmz.SetupWebhookWithManager,
		appanomaliesmobile.SetupWebhookWithManager,
		appcrashratemobile.SetupWebhookWithManager,
		appenablementmobile.SetupWebhookWithManager,
		appkeyperformance.SetupWebhookWithManager,
		application.SetupWebhookWithManager,
		apprequesterrors.SetupWebhookWithManager,
		notifications.SetupWebhookWithManager,
		technologiesapache.SetupWebhookWithManager,
		technologiesdotnet.SetupWebhookWithManager,
		technologiesgo.SetupWebhookWithManager,
		technologiesiis.SetupWebhookWithManager,
		technologiesjava.SetupWebhookWithManager,
		technologiesnginx.SetupWebhookWithManager,
		technologiesnodejs.SetupWebhookWithManager,
		technologiesopentracing.SetupWebhookWithManager,
		technologiesphp.SetupWebhookWithManager,
		technologiespython.SetupWebhookWithManager,
		technologiesvarnish.SetupWebhookWithManager,
		technologieswsmb.SetupWebhookWithManager,
		emailconnection.SetupWebhookWithManager,
		connectionmsentraid.SetupWebhookWithManager,
		connectionmsteams.SetupWebhookWithManager,
		requestsmuted.SetupWebhookWithManager,
		nettracer.SetupWebhookWithManager,
		monitornetwork.SetupWebhookWithManager,
		monitoroutagenetwork.SetupWebhookWithManager,
		traffic.SetupWebhookWithManager,
		zonenetwork.SetupWebhookWithManager,
		zones.SetupWebhookWithManager,
		notificationnotification.SetupWebhookWithManager,
		defaultmode.SetupWebhookWithManager,
		defaultversion.SetupWebhookWithManager,
		features.SetupWebhookWithManager,
		sidemasking.SetupWebhookWithManager,
		updatesoneagent.SetupWebhookWithManager,
		businessevents.SetupWebhookWithManager,
		davisevents.SetupWebhookWithManager,
		davisproblems.SetupWebhookWithManager,
		eventsopenpipeline.SetupWebhookWithManager,
		logs.SetupWebhookWithManager,
		metricsopenpipeline.SetupWebhookWithManager,
		sdlcevents.SetupWebhookWithManager,
		securityevents.SetupWebhookWithManager,
		spans.SetupWebhookWithManager,
		systemevents.SetupWebhookWithManager,
		userevents.SetupWebhookWithManager,
		usersessions.SetupWebhookWithManager,
		v2bizeventsingestsources.SetupWebhookWithManager,
		v2bizeventspipelinegroups.SetupWebhookWithManager,
		v2bizeventspipelines.SetupWebhookWithManager,
		v2bizeventsrouting.SetupWebhookWithManager,
		v2daviseventsingestsources.SetupWebhookWithManager,
		v2daviseventspipelinegroups.SetupWebhookWithManager,
		v2daviseventspipelines.SetupWebhookWithManager,
		v2daviseventsrouting.SetupWebhookWithManager,
		v2davisproblemsingestsources.SetupWebhookWithManager,
		v2davisproblemspipelinegroups.SetupWebhookWithManager,
		v2davisproblemspipelines.SetupWebhookWithManager,
		v2davisproblemsrouting.SetupWebhookWithManager,
		v2eventsingestsources.SetupWebhookWithManager,
		v2eventspipelinegroups.SetupWebhookWithManager,
		v2eventspipelines.SetupWebhookWithManager,
		v2eventsrouting.SetupWebhookWithManager,
		v2eventssdlcingestsources.SetupWebhookWithManager,
		v2eventssdlcpipelinegroups.SetupWebhookWithManager,
		v2eventssdlcpipelines.SetupWebhookWithManager,
		v2eventssdlcrouting.SetupWebhookWithManager,
		v2eventssecurityingestsources.SetupWebhookWithManager,
		v2eventssecuritypipelinegroups.SetupWebhookWithManager,
		v2eventssecuritypipelines.SetupWebhookWithManager,
		v2eventssecurityrouting.SetupWebhookWithManager,
		v2logsingestsources.SetupWebhookWithManager,
		v2logspipelinegroups.SetupWebhookWithManager,
		v2logspipelines.SetupWebhookWithManager,
		v2logsrouting.SetupWebhookWithManager,
		v2metricsingestsources.SetupWebhookWithManager,
		v2metricspipelinegroups.SetupWebhookWithManager,
		v2metricspipelines.SetupWebhookWithManager,
		v2metricsrouting.SetupWebhookWithManager,
		v2securityeventsingestsources.SetupWebhookWithManager,
		v2securityeventspipelinegroups.SetupWebhookWithManager,
		v2securityeventspipelines.SetupWebhookWithManager,
		v2securityeventsrouting.SetupWebhookWithManager,
		v2spansingestsources.SetupWebhookWithManager,
		v2spanspipelinegroups.SetupWebhookWithManager,
		v2spanspipelines.SetupWebhookWithManager,
		v2spansrouting.SetupWebhookWithManager,
		v2systemeventsingestsources.SetupWebhookWithManager,
		v2systemeventspipelinegroups.SetupWebhookWithManager,
		v2systemeventspipelines.SetupWebhookWithManager,
		v2systemeventsrouting.SetupWebhookWithManager,
		v2usereventsingestsources.SetupWebhookWithManager,
		v2usereventspipelinegroups.SetupWebhookWithManager,
		v2usereventspipelines.SetupWebhookWithManager,
		v2usereventsrouting.SetupWebhookWithManager,
		v2usersessionsingestsources.SetupWebhookWithManager,
		v2usersessionspipelinegroups.SetupWebhookWithManager,
		v2usersessionspipelines.SetupWebhookWithManager,
		v2usersessionsrouting.SetupWebhookWithManager,
		metricsopentelemetry.SetupWebhookWithManager,
		genienotification.SetupWebhookWithManager,
		services.SetupWebhookWithManager,
		config.SetupWebhookWithManager,
		teams.SetupWebhookWithManager,
		dutynotification.SetupWebhookWithManager,
		connectionpagerduty.SetupWebhookWithManager,
		alertingpg.SetupWebhookWithManager,
		anomaliespg.SetupWebhookWithManager,
		...
		fields.SetupWebhookWithManager,
		recordpropagationrules.SetupWebhookWithManager,
		availability.SetupWebhookWithManager,
		groupdetection.SetupWebhookWithManager,
		groupdetectionflags.SetupWebhookWithManager,
		groupmonitoring.SetupWebhookWithManager,
		grouprum.SetupWebhookWithManager,
		groupsimpledetection.SetupWebhookWithManager,
		monitoringprocess.SetupWebhookWithManager,
		monitoringrule.SetupWebhookWithManager,
		visibility.SetupWebhookWithManager,
		namingprocessgroup.SetupWebhookWithManager,
		namingorderprocessgroup.SetupWebhookWithManager,
		providerconfig.SetupWebhookWithManager,
		manager.SetupWebhookWithManager,
		sharinggroups.SetupWebhookWithManager,
		environments.SetupWebhookWithManager,
		report.SetupWebhookWithManager,
		attribute.SetupWebhookWithManager,
		namingrequest.SetupWebhookWithManager,
		namings.SetupWebhookWithManager,
		attributes.SetupWebhookWithManager,
		basedsampling.SetupWebhookWithManager,
		advancedcorrelation.SetupWebhookWithManager,
		hostheaders.SetupWebhookWithManager,
		ipdetermination.SetupWebhookWithManager,
		iplocations.SetupWebhookWithManager,
		overloadprevention.SetupWebhookWithManager,
		providerbreakdown.SetupWebhookWithManager,
		context.SetupWebhookWithManager,
		segment.SetupWebhookWithManager,
		anomaliesservice.SetupWebhookWithManager,
		anomaliesv2service.SetupWebhookWithManager,
		detectionrulesservice.SetupWebhookWithManager,
		externalwebrequest.SetupWebhookWithManager,
		externalwebservice.SetupWebhookWithManager,
		failure.SetupWebhookWithManager,
		fullwebrequest.SetupWebhookWithManager,
		fullwebservice.SetupWebhookWithManager,
		httpfailure.SetupWebhookWithManager,
		namingservice.SetupWebhookWithManager,
		namingorderservice.SetupWebhookWithManager,
		nownotification.SetupWebhookWithManager,
		splitting.SetupWebhookWithManager,
		connectionservicenow.SetupWebhookWithManager,
		replayresourcecapture.SetupWebhookWithManager,
		replaywebprivacy.SetupWebhookWithManager,
		permissionssettings.SetupWebhookWithManager,
		reliabilityguardian.SetupWebhookWithManager,
		notificationslack.SetupWebhookWithManager,
		normalization.SetupWebhookWithManager,
		sloslo.SetupWebhookWithManager,
		v2slo.SetupWebhookWithManager,
		attributespan.SetupWebhookWithManager,
		capturerule.SetupWebhookWithManager,
		contextpropagation.SetupWebhookWithManager,
		entrypoint.SetupWebhookWithManager,
		eventsspan.SetupWebhookWithManager,
		availabilitysynthetic.SetupWebhookWithManager,
		location.SetupWebhookWithManager,
		settingstoken.SetupWebhookWithManager,
		startfilters.SetupWebhookWithManager,
		notificationtrello.SetupWebhookWithManager,
		servicesmetrics.SetupWebhookWithManager,
		servicesopentel.SetupWebhookWithManager,
		windows.SetupWebhookWithManager,
		basedsamplingurl.SetupWebhookWithManager,
		analyticsusability.SetupWebhookWithManager,
		actionmetrics.SetupWebhookWithManager,
		experiencescore.SetupWebhookWithManager,
		groupuser.SetupWebhookWithManager,
		sessionmetrics.SetupWebhookWithManager,
		settingsuser.SetupWebhookWithManager,
		useruser.SetupWebhookWithManager,
		opsnotification.SetupWebhookWithManager,
		anomaliesvmware.SetupWebhookWithManager,
		vmware.SetupWebhookWithManager,
		alertingvulnerability.SetupWebhookWithManager,
		code.SetupWebhookWithManager,
		settingsvulnerability.SetupWebhookWithManager,
		thirdparty.SetupWebhookWithManager,
		thirdpartyattr.SetupWebhookWithManager,
		thirdpartyk8s.SetupWebhookWithManager,
		appanomaliesweb.SetupWebhookWithManager,
		appautoinjection.SetupWebhookWithManager,
		appbeaconendpoint.SetupWebhookWithManager,
		appbeaconorigins.SetupWebhookWithManager,
		appcustomconfigproperties.SetupWebhookWithManager,
		appcustomerrors.SetupWebhookWithManager,
		appcustominjection.SetupWebhookWithManager,
		appcustomproprestrictions.SetupWebhookWithManager,
		appenablementweb.SetupWebhookWithManager,
		appinjectioncookie.SetupWebhookWithManager,
		appipaddressexclusion.SetupWebhookWithManager,
		appjavascriptfilename.SetupWebhookWithManager,
		appjavascriptupdates.SetupWebhookWithManager,
		appjavascriptversion.SetupWebhookWithManager,
		appkeyperformancecustom.SetupWebhookWithManager,
		appkeyperformanceload.SetupWebhookWithManager,
		appkeyperformancexhr.SetupWebhookWithManager,
		applicationweb.SetupWebhookWithManager,
		appmanualinsertion.SetupWebhookWithManager,
		apprequesterrorsweb.SetupWebhookWithManager,
		appresourcecleanup.SetupWebhookWithManager,
		appresourcetypes.SetupWebhookWithManager,
		notificationwebhook.SetupWebhookWithManager,
		notificationxmatters.SetupWebhookWithManager,
	} {
