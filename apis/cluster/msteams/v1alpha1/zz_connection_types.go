...
type ConnectionInitParameters struct {
	...
	// (String) The name of the Microsoft Teams connection
...
type Connection struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.webhookSecretRef)",message="spec.forProvider.webhookSecretRef is a required parameter"
