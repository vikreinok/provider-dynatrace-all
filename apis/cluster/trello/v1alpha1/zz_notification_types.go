...
type NotificationInitParameters struct {
	...
	AuthorizationTokenSecretRef v1.SecretKeySelector `json:"authorizationTokenSecretRef" tf:"-"`
	...
	// (String) The description of the Trello card. Type '{' for placeholder suggestions.. #### Available placeholders
	...
	// (String) Trello list ID new problem cards should be assigned to
	...
	// (String) Trello list ID resolved problem cards should be assigned to
	...
	// (String) The card text and problem placeholders to appear on new problem cards. Type '{' for placeholder suggestions.. #### Available placeholders
	// {ImpactedEntity}: A short description of the problem and impacted entity (or multiple impacted entities).
...
type Notification struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.authorizationTokenSecretRef)",message="spec.forProvider.authorizationTokenSecretRef is a required parameter"
