...
type EntryPointInitParameters struct {
	...
	Matches []EntryPointMatchesInitParameters `json:"matches,omitempty" tf:"matches,omitempty"`
...
type EntryPointMatchesInitParameters struct {

	// (Block List, Min: 1) Matching strategies for the Span (see below for nested schema)
	// Matching strategies for the Span
	Match []EntryPointMatchesMatchInitParameters `json:"match,omitempty" tf:"match,omitempty"`
}

type EntryPointMatchesMatchInitParameters struct {
...
type EntryPointMatchesMatchObservation struct {
...
type EntryPointMatchesMatchParameters struct {
...
type EntryPointMatchesObservation struct {

	// (Block List, Min: 1) Matching strategies for the Span (see below for nested schema)
	// Matching strategies for the Span
	Match []EntryPointMatchesMatchObservation `json:"match,omitempty" tf:"match,omitempty"`
}

type EntryPointMatchesParameters struct {

	// (Block List, Min: 1) Matching strategies for the Span (see below for nested schema)
	// Matching strategies for the Span
	// +kubebuilder:validation:Optional
	Match []EntryPointMatchesMatchParameters `json:"match" tf:"match,omitempty"`
}
...
type EntryPointObservation struct {
	...
	// (Block List, Min: 1, Max: 1) Matching strategies for the Span (see below for nested schema)
	// Matching strategies for the Span
	Matches []EntryPointMatchesObservation `json:"matches,omitempty" tf:"matches,omitempty"`
...
type EntryPointParameters struct {
	...
	// Matching strategies for the Span
	// +kubebuilder:validation:Optional
	Matches []EntryPointMatchesParameters `json:"matches,omitempty" tf:"matches,omitempty"`
...
type EntryPointSpec struct {
	...
	ForProvider     EntryPointParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider EntryPointInitParameters `json:"initProvider,omitempty"`
}

// EntryPointStatus defines the observed state of EntryPoint.
type EntryPointStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        EntryPointObservation `json:"atProvider,omitempty"`
}
...
// EntryPoint is the Schema for the EntryPoints API. The resource
...
// EntryPointList contains a list of EntryPoints
...
var (
	...
	EntryPoint_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: EntryPoint_Kind}.String()
	EntryPoint_KindAPIVersion   = EntryPoint_Kind + "." + CRDGroupVersion.String()
	EntryPoint_GroupVersionKind = CRDGroupVersion.WithKind(EntryPoint_Kind)
)
