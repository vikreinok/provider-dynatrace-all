...
type FailureInitParameters struct {
...
type FailureSpec struct {
	...
	// autoscaler.
	InitProvider FailureInitParameters `json:"initProvider,omitempty"`
}
...
// Failure is the Schema for the Failures API. The resource
...
// FailureList contains a list of Failures
...
var (
	...
	Failure_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Failure_Kind}.String()
	Failure_KindAPIVersion   = Failure_Kind + "." + CRDGroupVersion.String()
	Failure_GroupVersionKind = CRDGroupVersion.WithKind(Failure_Kind)
)

func init() {
	SchemeBuilder.Register(&Failure{}, &FailureList{})
}
