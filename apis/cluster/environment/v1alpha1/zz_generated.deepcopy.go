...
func (in *DdusInitParameters) DeepCopyInto(out *DdusInitParameters) {
	*out = *in
	if in.Annual != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DdusInitParameters.
func (in *DdusInitParameters) DeepCopy() *DdusInitParameters {
	if in == nil {
		return nil
	}
	out := new(DdusInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DemUnitsInitParameters) DeepCopyInto(out *DemUnitsInitParameters) {
	*out = *in
	if in.Annual != nil {
		in, out := &in.Annual, &out.Annual
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DemUnitsInitParameters.
func (in *DemUnitsInitParameters) DeepCopy() *DemUnitsInitParameters {
	if in == nil {
		return nil
	}
	out := new(DemUnitsInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EnvironmentInitParameters) DeepCopyInto(out *EnvironmentInitParameters) {
	*out = *in
	...
	if in.Quotas != nil {
		...
		*out = make([]QuotasInitParameters, len(*in))
		for i := range *in {
...
func (in *EnvironmentObservation) DeepCopyInto(out *EnvironmentObservation) {
	*out = *in
	...
	if in.Quotas != nil {
		in, out := &in.Quotas, &out.Quotas
		*out = make([]QuotasObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QuotasInitParameters) DeepCopyInto(out *QuotasInitParameters) {
	*out = *in
	if in.Ddus != nil {
		in, out := &in.Ddus, &out.Ddus
		*out = make([]DdusInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DemUnits != nil {
		...
		*out = make([]DemUnitsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Synthetic != nil {
		...
		*out = make([]SyntheticInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.UserSessions != nil {
		...
		*out = make([]UserSessionsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QuotasInitParameters.
func (in *QuotasInitParameters) DeepCopy() *QuotasInitParameters {
	if in == nil {
		return nil
	}
	out := new(QuotasInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *QuotasObservation) DeepCopyInto(out *QuotasObservation) {
	*out = *in
	if in.Ddus != nil {
		in, out := &in.Ddus, &out.Ddus
		*out = make([]DdusObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DemUnits != nil {
		in, out := &in.DemUnits, &out.DemUnits
		*out = make([]DemUnitsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.Synthetic != nil {
		in, out := &in.Synthetic, &out.Synthetic
		*out = make([]SyntheticObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.UserSessions != nil {
		in, out := &in.UserSessions, &out.UserSessions
		*out = make([]UserSessionsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SyntheticInitParameters) DeepCopyInto(out *SyntheticInitParameters) {
	*out = *in
	if in.Annual != nil {
		in, out := &in.Annual, &out.Annual
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyntheticInitParameters.
func (in *SyntheticInitParameters) DeepCopy() *SyntheticInitParameters {
	if in == nil {
		return nil
	}
	out := new(SyntheticInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserSessionsInitParameters) DeepCopyInto(out *UserSessionsInitParameters) {
	*out = *in
	if in.Annual != nil {
		in, out := &in.Annual, &out.Annual
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserSessionsInitParameters.
func (in *UserSessionsInitParameters) DeepCopy() *UserSessionsInitParameters {
	if in == nil {
		return nil
	}
	out := new(UserSessionsInitParameters)
	in.DeepCopyInto(out)
	return out
}
