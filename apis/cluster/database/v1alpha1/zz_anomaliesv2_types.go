...
type AnomaliesV2FailureRateObservation struct {
...
type AnomaliesV2FailureRateParameters struct {
...
type AnomaliesV2InitParameters struct {
	...
	// Failure rate
	FailureRate []AnomaliesV2FailureRateInitParameters `json:"failureRate,omitempty" tf:"failure_rate,omitempty"`
	...
	// Response time
	ResponseTime []AnomaliesV2ResponseTimeInitParameters `json:"responseTime,omitempty" tf:"response_time,omitempty"`
...
type AnomaliesV2Observation struct {
	...
	// (Block List, Min: 1, Max: 1) Failure rate (see below for nested schema)
	// Failure rate
	FailureRate []AnomaliesV2FailureRateObservation `json:"failureRate,omitempty" tf:"failure_rate,omitempty"`
	...
	// (Block List, Min: 1, Max: 1) Response time (see below for nested schema)
	// Response time
	ResponseTime []AnomaliesV2ResponseTimeObservation `json:"responseTime,omitempty" tf:"response_time,omitempty"`
...
type AnomaliesV2Parameters struct {
	...
	// Failure rate
	// +kubebuilder:validation:Optional
	FailureRate []AnomaliesV2FailureRateParameters `json:"failureRate,omitempty" tf:"failure_rate,omitempty"`
	...
	// Response time
	// +kubebuilder:validation:Optional
	ResponseTime []AnomaliesV2ResponseTimeParameters `json:"responseTime,omitempty" tf:"response_time,omitempty"`
...
type AnomaliesV2ResponseTimeInitParameters struct {
...
type AnomaliesV2ResponseTimeObservation struct {
...
type AnomaliesV2ResponseTimeParameters struct {
