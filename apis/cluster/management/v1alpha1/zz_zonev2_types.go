...
type AttributeConditionsInitParameters struct {
	...
	Condition []AttributeConditionsConditionInitParameters `json:"condition,omitempty" tf:"condition,omitempty"`
}
...
type AttributeConditionsObservation struct {
	...
	// (Block Set, Min: 1) Attribute conditions (see below for nested schema)
	// Attribute conditions
	Condition []AttributeConditionsConditionObservation `json:"condition,omitempty" tf:"condition,omitempty"`
}
...
type AttributeConditionsParameters struct {
	...
	// Attribute conditions
	// +kubebuilder:validation:Optional
	Condition []AttributeConditionsConditionParameters `json:"condition" tf:"condition,omitempty"`
}
...
type ZoneV2InitParameters struct {
	...
	// Rules
	Rules []ZoneV2RulesInitParameters `json:"rules,omitempty" tf:"rules,omitempty"`
}
...
type ZoneV2Observation struct {
	...
	// (Block List, Max: 1) Rules (see below for nested schema)
	// Rules
	Rules []ZoneV2RulesObservation `json:"rules,omitempty" tf:"rules,omitempty"`
}
...
type ZoneV2Parameters struct {
	...
	// Rules
	// +kubebuilder:validation:Optional
	Rules []ZoneV2RulesParameters `json:"rules,omitempty" tf:"rules,omitempty"`
}

type ZoneV2RulesInitParameters struct {
...
// ZoneV2 is the Schema for the ZoneV2s API. The resource
