...
type AppKeyPerformanceXhrFallbackThresholdsObservation struct {
...
type AppKeyPerformanceXhrFallbackThresholdsParameters struct {
...
type AppKeyPerformanceXhrInitParameters struct {
	...
	FallbackThresholds []AppKeyPerformanceXhrFallbackThresholdsInitParameters `json:"fallbackThresholds,omitempty" tf:"fallback_thresholds,omitempty"`
	...
	Thresholds []AppKeyPerformanceXhrThresholdsInitParameters `json:"thresholds,omitempty" tf:"thresholds,omitempty"`
}

type AppKeyPerformanceXhrObservation struct {

	// (Block List, Max: 1) If the selected key performance metric is not detected, the User action duration metric is used instead. (see below for nested schema)
	// If the selected key performance metric is not detected, the **User action duration** metric is used instead.
	FallbackThresholds []AppKeyPerformanceXhrFallbackThresholdsObservation `json:"fallbackThresholds,omitempty" tf:"fallback_thresholds,omitempty"`
	...
	// (Block List, Min: 1, Max: 1) Set the Tolerating and Frustrated performance thresholds for this action type. (see below for nested schema)
	// Set the Tolerating and Frustrated performance thresholds for this action type.
	Thresholds []AppKeyPerformanceXhrThresholdsObservation `json:"thresholds,omitempty" tf:"thresholds,omitempty"`
}

type AppKeyPerformanceXhrParameters struct {

	// (Block List, Max: 1) If the selected key performance metric is not detected, the User action duration metric is used instead. (see below for nested schema)
	// If the selected key performance metric is not detected, the **User action duration** metric is used instead.
	// +kubebuilder:validation:Optional
	FallbackThresholds []AppKeyPerformanceXhrFallbackThresholdsParameters `json:"fallbackThresholds,omitempty" tf:"fallback_thresholds,omitempty"`
	...
	// Set the Tolerating and Frustrated performance thresholds for this action type.
	// +kubebuilder:validation:Optional
	Thresholds []AppKeyPerformanceXhrThresholdsParameters `json:"thresholds,omitempty" tf:"thresholds,omitempty"`
}

type AppKeyPerformanceXhrThresholdsInitParameters struct {
...
type AppKeyPerformanceXhrThresholdsObservation struct {
...
type AppKeyPerformanceXhrThresholdsParameters struct {
...
type AppKeyPerformanceXhrSpec struct {
	...
	// autoscaler.
	InitProvider AppKeyPerformanceXhrInitParameters `json:"initProvider,omitempty"`
}
...
// AppKeyPerformanceXhr is the Schema for the AppKeyPerformanceXhrs API. The resource
// +kubebuilder:printcolumn:name="SYNCED",type="string",JSONPath=".status.conditions[?(@.type=='Synced')].status"
// +kubebuilder:printcolumn:name="READY",type="string",JSONPath=".status.conditions[?(@.type=='Ready')].status"
// +kubebuilder:printcolumn:name="EXTERNAL-NAME",type="string",JSONPath=".metadata.annotations.crossplane\\.io/external-name"
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:resource:scope=Cluster,categories={crossplane,managed,dynatrace}
type AppKeyPerformanceXhr struct {
	...
	Spec   AppKeyPerformanceXhrSpec   `json:"spec"`
	Status AppKeyPerformanceXhrStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AppKeyPerformanceXhrList contains a list of AppKeyPerformanceXhrs
type AppKeyPerformanceXhrList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AppKeyPerformanceXhr `json:"items"`
}

// Repository type metadata.
var (
	AppKeyPerformanceXhr_Kind             = "AppKeyPerformanceXhr"
	AppKeyPerformanceXhr_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AppKeyPerformanceXhr_Kind}.String()
	AppKeyPerformanceXhr_KindAPIVersion   = AppKeyPerformanceXhr_Kind + "." + CRDGroupVersion.String()
	AppKeyPerformanceXhr_GroupVersionKind = CRDGroupVersion.WithKind(AppKeyPerformanceXhr_Kind)
)

func init() {
	SchemeBuilder.Register(&AppKeyPerformanceXhr{}, &AppKeyPerformanceXhrList{})
}
