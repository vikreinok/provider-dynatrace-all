...
type CaptureRuleObservation struct {
...
type CaptureRuleParameters struct {
...
type CaptureRuleSpec struct {
	...
	// autoscaler.
	InitProvider CaptureRuleInitParameters `json:"initProvider,omitempty"`
}
...
// CaptureRule is the Schema for the CaptureRules API. The resource
...
type CaptureRule struct {
	...
	Spec   CaptureRuleSpec   `json:"spec"`
	Status CaptureRuleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CaptureRuleList contains a list of CaptureRules
type CaptureRuleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CaptureRule `json:"items"`
}

// Repository type metadata.
var (
	CaptureRule_Kind             = "CaptureRule"
	CaptureRule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CaptureRule_Kind}.String()
	CaptureRule_KindAPIVersion   = CaptureRule_Kind + "." + CRDGroupVersion.String()
	CaptureRule_GroupVersionKind = CRDGroupVersion.WithKind(CaptureRule_Kind)
)

func init() {
	SchemeBuilder.Register(&CaptureRule{}, &CaptureRuleList{})
}
