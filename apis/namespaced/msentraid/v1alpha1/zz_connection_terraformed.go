...
func (mg *Connection) GetTerraformResourceType() string {
	return "dynatrace_msentraid_connection"
}

// GetConnectionDetailsMapping for this Connection
func (tr *Connection) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"application_id": "applicationIdSecretRef", "client_secret": "clientSecretSecretRef", "directory_id": "directoryIdSecretRef"}
}
