...
// GetInitParameters of this Issues
func (tr *Issues) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Issues
func (tr *Issues) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
