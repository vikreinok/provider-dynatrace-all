...
PROJECT_REPO ?= github.com/vikreinok/$(PROJECT_NAME)-all
...
export TERRAFORM_PROVIDER_VERSION ?= 1.96.0
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-dynatrace_v1.96.0
